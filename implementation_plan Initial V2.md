...
│       ├── __init__.py
│       ├── models.py                     # CategorieMouvement, Mouvement, Cotisation
│       ├── serializers.py
│       ├── views.py
│       ├── urls.py
│       ├── admin.py
...
| `Cotisation` | `SoftDeleteModel` | Cotisation attendue par membre par période |
...
class Mouvement(SoftDeleteModel):
    ...
    enregistre_par = models.ForeignKey("membres.Membre", on_delete=models.PROTECT,
...
class Cotisation(SoftDeleteModel):
    ...
    membre       = models.ForeignKey("membres.Membre", on_delete=models.CASCADE, related_name="cotisations")
    periode      = models.CharField(max_length=50)
    montant_du   = models.DecimalField(max_digits=10, decimal_places=2)
    montant_paye = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    mouvement    = models.ForeignKey(Mouvement, null=True, blank=True, on_delete=models.SET_NULL)
    statut       = models.CharField(max_length=20, choices=StatutCotisation.choices, default=StatutCotisation.EN_ATTENTE)
```
